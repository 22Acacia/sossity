...
(def big-dataflows {:pipeline1bts {:name "pipeline1bts",
                    ...
                    :pipeline3bts {:name "pipeline3bts",
                                   ...
                                   :optional_args {:stagingLocation "gs://hx-test/staging-eu",
                                                   :zone "europe-west1-c",
                                                   :workerMachineType "n1-standard-1",
                                                   :errorPipelineName "projects/hx-test/topics/pipeline3bts_err",
                    ...
                    :pipeline2bts {:name "pipeline2bts",
                                   ...
                                   :optional_args {:stagingLocation "gs://hx-test/staging-eu",
                                                   :zone "europe-west1-c",
                                                   :workerMachineType "n1-standard-1",
                                                   :errorPipelineName "projects/hx-test/topics/pipeline2bts_err",
                    ...
                    :orionpipe {:name "orionpipe",
                                ...
                                :optional_args {:stagingLocation "gs://hx-test/staging-eu",
                                                :zone "europe-west1-c",
                                                :workerMachineType "n1-standard-1",
                                                :errorPipelineName "projects/hx-test/topics/orionpipe_err",
